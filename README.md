...
<img width="610" height="647" alt="image-1" src="https://github.com/user-attachments/assets/4eaf0e53-099e-42f2-a9a9-2e0d1a2987aa" />

### 3단계 — 데이터베이스 ID 확인하기

데이터베이스 설정 보기 버튼 클릭 ➜ 데이터 소스 관리에서 해당 DB 소스 ID 복사

<img width="286" height="529" alt="image" src="https://github.com/user-attachments/assets/452ee366-6dc9-4400-a511-a8ed7437c342" />
